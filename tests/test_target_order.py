...
def test_gdb_cached_deps():
    ...
    sorted_by_order = _sort_targets([*all_names, "gdb-morello-purecap"], add_dependencies=False, skip_sdk=True)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(CompilationTargets.CHERIBSD_RISCV_ZCHERI093_PURECAP, ["alliance-llvm"]),
        pytest.param(CompilationTargets.CHERIBSD_RISCV_Y_PURECAP, ["alliance-llvm"]),
        ...
        pytest.param(CompilationTargets.FREESTANDING_RISCV64_ZCHERI093_PURECAP, ["alliance-llvm"]),
        pytest.param(CompilationTargets.FREESTANDING_RISCV64_Y_PURECAP, ["alliance-llvm"]),
        ...
        pytest.param(CompilationTargets.CHERIOS_RISCV_XCHERI_PURECAP, ["cherios-llvm"]),
