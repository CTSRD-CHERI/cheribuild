...
@pytest.mark.parametrize(
    ...
    [
        ...
        pytest.param(CompilationTargets.CHERIBSD_RISCV_Y_PURECAP, ["cheri-std093-llvm"]),
        ...
        pytest.param(CompilationTargets.FREESTANDING_RISCV64_Y_PURECAP, ["cheri-std093-llvm"]),
