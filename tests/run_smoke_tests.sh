...
try_run ./test-scripts/run_libcxx_tests.py -p --architecture riscv64 --ssh-key /path/to/build/insecure_test_ssh_key.pub --kernel /path/to/output/kernel-riscv64.QEMU-MFS-ROOT --qemu-cmd /path/to/output/sdk/bin/qemu-system-riscv64cheri --build-dir /path/to/build/upstream-llvm-libs-riscv64-build --sysroot-dir /path/to/output/rootfs-riscv64 --lit-debug-output --ssh-executor-script /path/to/upstream-llvm-project/runtimes/../libcxx/utils/ssh.py --parallel-jobs 2
